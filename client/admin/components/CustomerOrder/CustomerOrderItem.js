...
class CustomerOrderItem extends React.Component{
    ...
    render(){
        ...
        let {id,OrderDate,OrderNo,Customer,TotalAmount,ShippingCost,TotalQty} = order ? order : {};
               ...
               <Card onClick={()=>{router.push(`/customer/order/detail/${id}`);}}>
                    <CardText>
                        <div>
                            ...
                            <div className="row">
                                <span>Customer </span>: {Customer.FullName ? Customer.FullName : Customer.UserName} 
                            </div>
                            <div className="row">
